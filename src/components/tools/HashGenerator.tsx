  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-1 text-xs text-neutral-500">
        ...
        <p>
          <strong>SHA-1:</strong> 160-bit (40 chars) — Legacy, avoid for
          security.
        </p>
        <p>
          <strong>SHA-256:</strong> 256-bit (64 chars) — Recommended for most
          uses.
        </p>
        <p>
          <strong>SHA-512:</strong> 512-bit (128 chars) — Strongest, best for
          passwords.
        </p>
      </div>
    </div>
